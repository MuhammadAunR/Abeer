        ...
        <main id='about' className='h-fit flex items-center justify-between gap-7 mx-5 lg:mx-10 py-14 max-lg:flex-col'>
            <div className='flex flex-col items-start gap-10'>
                ...
                <div className='flex flex-col items-start gap-5'>
                    <h2 className='text-4xl'>At <span className='font-serif font-bold text-accent'>Abeer</span>, nature is not just an inspiration — it is our language.</h2>
                    <p className='text-gray-400'>
                        The golden warmth of desert blooms, the rich depth of oud and amber, the gentle
                        whisper of cool evening breeze — each element lives within our fragrances, breathing
                    ...
                    <p className='text-xl'>Every fragrance we craft is a memory waiting to be worn.</p>
                </div>
            </div>
