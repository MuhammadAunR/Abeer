    ...
    return (
        <main id='contact' className='bg-surface h-fit rounded-2xl my-6 mx-2 md:m-12'>
            ...
            <section className='flex items-center justify-between gap-5 px-5 md:px-20 py-10 max-lg:flex-col max-lg:items-start'>
                <div>
                    <h6 className="text-xl">Find your signature scent !</h6>

                    <p className="text-sm text-gray-400">
                        Not sure what to choose? Chat with us and get personalized recommendations.
                    </p>
                    <div className='py-5 flex items-center gap-5 flex-wrap'>
                        <a
                            href="https://wa.me/923286536520?text=Hi%20I%20need%20help%20choosing%20a%20perfume"
                            target="_blank"
                        >
                            <Button text="Chat on WhatsApp" classes="px-7 py-2" />
                        </a>
                    </div>
                </div>
                <div className='flex items-center gap-10'>
                    ...
                    <div className='flex flex-col gap-8'>
                        ...
                        <ul className='flex flex-col gap-2 font-light'>
                            <Link href={'/'} className='hover:text-accent transition-colors ease-linear cursor-pointer'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill='currentColor' width="30" height="30" viewBox="0 0 32 32">
